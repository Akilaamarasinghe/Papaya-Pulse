...
try:
    model = joblib.load('papaya_grade_models/papaya_grade_model.pkl')
    label_encoder = joblib.load('papaya_grade_models/label_encoder.pkl')
    with open('papaya_grade_models/model_metadata.json', 'r') as f:
...
@app.route('/predict-papaya-grade', methods=['POST'])
def predict():
