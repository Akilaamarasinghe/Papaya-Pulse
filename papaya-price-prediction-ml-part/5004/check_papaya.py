...
papaya_model, papaya_classes = load_vit_model("models/papaya_detector.pth")
...
def predict_pipeline(img):
    ...
    print(f"Papaya Probability: {papaya_prob:.4f}, Not Papaya Probability: {not_papaya_prob:.4f}")
