...
RISK_ACTION_GUIDE = {
    "LOW": {
        ...
        "urgency_si": "අඩු  — සාමාන්‍ය ගොවිතැන් පරීක්ෂාව දිගටම කරගෙන යන්න.",
    ...
    "MEDIUM": {
        ...
        "urgency_si": "මධ්‍යම  — දින 3–5 ඇතුළත වැළකීමේ ප්‍රතිකාරය ආරම්භ කරන්න.",
    ...
    "HIGH": {
        ...
        "urgency_si": "ඉහළ  — පැය 24–48 ඇතුළත ප්‍රතිකාරය ආරම්භ කරන්න.",
    ...
    "CRITICAL": {
        ...
        "urgency_si": "හදිසි තත්ත්වය — ළඟම කෘෂිකර්ම දෙපාර්තමේන්තු නිලධාරියා හමු වන්න. "
                      "හදිසි ප්‍රතිකාරය සහ ආසාදිත පැළ ඉවත් කිරීමට සිදුවිය හැක.",
...
DISEASE_EXPLAIN_SI = {
    "anthracnose": (
        "ඇන්ත්‍රැක්නෝස් (කලු පුල්ලි රෝගය) (Colletotrichum gloeosporioides) රෝගය උෂ්ණ, තෙත් සහ වැසි "
        "කාළගුණයේ ඉක්මනින් පැතිර යයි. සතිය ඇතුළත 20 mm ඉක්මවූ වර්ෂාපතනය සහ "
        "උෂ්ණත්වය 25–30 °C ඇත්නම් රෝගය තීව්‍ර වේ. "
        "ජල පාලනය  කිරීම රෝගය සෙමෙන් ව්‍යාප්ත කරයි."
    ),
    "mosaic": (
        "පැපෝල් මොසේයික් වයිරසය (වලාකුලු රෝගය) (PapMV) කුඩිත්තන් (aphids)  මගින් පැතිරේ. "
        "වියළි සහ උෂ්ණ කාළගුණය වයිරස් පැතිරීම වැඩි කරයි. "

    ),
    "mites": (
        "රතු මකුළු මයිටාවන් (Tetranychus urticae) උෂ්ණ, වියළි කාළගුණයේ ශීඝ්‍රයෙන් වැඩිවේ. "
        "සතිය ඇතුළත 5 mm ට අඩු වර්ෂාව සහ 28 °C ට ඉහළ උෂ්ණත්වය මයිටාවන්  ඉක්මනින් වර්ධනය කරයි. වර්ෂාව සාමාන්‍ය ලෙස ලැබේනම් මයිටාවන් ස්වාභාවිකව ඉවත් කරයි."
    ),
    "leaf_curl": (
        "පැපෝල් ලිෆ් කර්ල් (කොලකොඩ වීමේ රෝගය) වයිරසය සුදු මැස්සන් (whitefly) සහ පැල මැක්කා (thrips) "
        "යන කෘමීන් මගින් පැතිරේ. මෘදු වර්ෂාවෙන් පසු සාමාන්‍ය ආර්ද්‍රතාව ඇති "
        "උෂ්ණ කාළගුණයේ මෙම කෘමීන් වඩාත් ක්‍රියාශීලී වේ."
        "කෘමි පාලනය ඵලදායී ය."
    ),
}
...
DISEASE_RISK_OUTLOOK_SI = {
    ...
    ("anthracnose", "MEDIUM"):   "ඇන්ත්‍රැක්නෝස් ස්පෝරා තෙත් ස්ථානවල ප්‍රජනනය විය හැකිය. ප්‍රතිකාරයකින් තොරව දින 7–10 ඇතුළත ඵ්ලදාවට හෝ ශාකවලට බලපෑම් ඇතිවිය හැක",
    ("anthracnose", "HIGH"):     "දිලීර ව්‍යාප්තිය ඉක්මනින් සිදු විය හැකිය. දින 3–5 ඇතුළත ඵ්ලදාවට හෝ ශාකවලට බලපෑම් ඇතිවිය හැක. දැන්ම ප්‍රතිකාරය ආරම්භ කිරීම ඉතා වැදගත්.",
    ("anthracnose", "CRITICAL"): "හදිසි තත්ත්වය: දිලීර ආසාදනයට වර්තමාන කාළගුණය ඉතා අහිතකරය. හදිසි ප්‍රතිකාරයකින් තොරව සති 2 ඇතුළත අස්වැන්නෙන් 50–80% ක් හානි විය හැකිය. කෘෂිකර්ම නිලධාරියා හමු වන්න.",
    ("mosaic", "LOW"):           "කුඩිත්තන් ක්‍රියාකාරීත්වය අඩුයි. රෝගය ස්ථාවරය. රෝගී ශාක පත්‍ර ඉවත් කිරීම සහ වල් පැල පාලනය කරන්න.",
    ("mosaic", "MEDIUM"):        "සති 1–2 ඇතුළත අසල ශාකවලට වයිරසය පැතිරිය හැකිය. රෝගී ශාක ඉවත් කර ආලෝකය පරාවර්තන ආවරණ (mulch) යෙදීමට හැකිනම් වඩාත් සුදුසුය.",
    ("mosaic", "HIGH"):          "කුඩිත්තන් ගහනය ඉහළ. වයිරසය ශීඝ්‍රයෙන් ව්‍යාප්ත වේ. රෝගී ශාක ඉවත් කිරීම ඉතා ඉක්මනින් කළ යුතුය.",
    ("mosaic", "CRITICAL"):      "සති 2 ඇතුළත ශාක පේළිවලම රෝගය ව්‍යාප්ත විය හැකිය. රෝගී ශාක වහාම ඉවත් කරන්න.",
    ("mites", "LOW"):            "සාමාන්‍ය ලෙස බෙහෙත්  ඉසීම ප්‍රමාණවත්.",
    ("mites", "MEDIUM"):         "දින 5–7 ඇතුළත ව්‍යාප්තිය වැඩිවිය හැක. කොහොඹ තෙල් (Neem oil) හෝ සල්ෆර් (Sulphur dust) ඉසී ශාක ආරක්ෂා කරන්න.",
    ("mites", "HIGH"):           "දිනකි 3–4 ඇතුළත ශීඝ්‍ර ව්‍යාප්තිය. කොළ රතු-රන්වන් (bronzing) ලකුණු  ලෙස පැතිරේ. ඇබමෙක්ටින් (Abamectin) ඉසීම දැනම ආරම්භ කරන්න.",
    ("mites", "CRITICAL"):       "රතු මකුළු මයිටාවන් (mite) අර්බුදය. සතියක් ඇතුළත ආසාදිත ශාඛාවල කොළ ගැලවී යාම සිදු විය හැකිය.",
    ("leaf_curl", "LOW"):        "ශාක නිරීක්ෂණය සාමාන්‍ය ලෙස දිගටම කරගෙන යන්න.",
    ("leaf_curl", "MEDIUM"):     "සාමාන්‍ය  (whitefly/thrips) ක්‍රියාකාරිත්වය. සති 1–2 ඇතුළත නව කොළ ආසාදනය ඇතිවිය හැකිය. ස්පිනෝසැඩ් (Spinosad 5%) හෝ  Imidacloprid 70%WG ඉසීම ආරම්භ කරන්න.",
    ("leaf_curl", "HIGH"):       "ශීඝ්‍රයෙන් ආසාදිත වේ. ක්ෂණිකව කෘමිනාශකය ඉසිය යුතුය.",
    ("leaf_curl", "CRITICAL"):   "රෝගය ශීඝ්‍රයෙන් ඉහළ යයි. සති 1–2 ඇතුළත සියලු කොල අසාදනයට අවදානමක් ඇත. හදිසි ක්‍රමෝපාය ක්‍රියාත්මක කළ යුතුය.",
}
...
def _explain_why_risk_si(disease: str, severity: str,
    ...
    if disease == "anthracnose":
        ...
        if rain7d < 5:
            factors.append(f"ඉතා අඩු වර්ෂාව ({rain7d:.0f} mm) — රතු මකුළු මයිටාවන් ස්වාභාවිකව ඉවත් නොවේ")
        if tmean >= 28:
            factors.append(f"ඉහළ උෂ්ණත්වය ({tmean:.1f} °C) රතු මකුළු මයිටාවන් ප්‍රජනනය ත්වරණය කරයි")
        if humidity < 55:
            factors.append(f"අඩු ආර්ද්‍රතාවය ({humidity:.0f}%) රතු මකුළු මයිටාවන් ඉහළ යයි")
    elif disease == "leaf_curl":
        if 22 <= tmean <= 33:
            factors.append(f"උෂ්ණත්වය ({tmean:.1f} °C) whitefly/thrips ප්‍රජනනයට හිතකරය")
        if 65 <= humidity <= 85:
            factors.append(f"ආර්ද්‍රතාවය ({humidity:.0f}%) ව්‍යාප්තිය වැඩි කරයි")
        if rain7d < 5:
